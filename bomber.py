...
def do_zip_update():
    success = False
    if DEBUG_MODE:
        zip_url = "https://github.com/anshsx/billi-v2/archive/dev.zip"
        dir_name = "billi-dev"
    else:
        zip_url = "https://github.com/anshsx/billi-v2/archive/master.zip"
    ...
    if success:
        mesgdcrt.SuccessMessage("Billi v2 was updated to the latest version")
        mesgdcrt.GeneralMessage(
            "Please run the script again to load the latest version")
    else:
        mesgdcrt.FailureMessage("Unable to update Billi.")
        mesgdcrt.WarningMessage(
            "Grab The Latest one From https://github.com/anshsx/billi-v2.git")
...
def do_git_update():
    ...
    if success:
        ...
        print(
            "git checkout . && "
            "git pull https://github.com/anshsx/billi-v2.git HEAD")
    sys.exit()
...
def notifyen():
    try:
        if DEBUG_MODE:
            url = "https://github.com/anshsx/billi-v2/raw/dev/.notify"
        else:
            url = "https://github.com/anshsx/billi-v2/raw/master/.notify"
...
def get_phone_info():
    while True:
        ...
        if ((len(target) <= 9) or (len(target) >= 12)):
            mesgdcrt.WarningMessage(
